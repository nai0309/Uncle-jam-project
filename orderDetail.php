...
<body>
  ...
  $orders_detail = select('order_detail', $field, $select_data);
            ...
            <form action="api.php?do=productMdy" method="post">
              <tr>
                ...
                <td class="text-center">
                  <button class="btn-outline-uncle btn-readmore my-1" type="submit" style="width: auto;background-color:white;"><a>儲存</a></button>
                  <br>
                  <button class="btn-outline-uncle btn-readmore" style="width: auto">
                  <a href="api.php?do=productDel&delId=<?= $product['id'] ?>">刪除</a>
                  </button>
                </td>
              </tr>
              </form>
            ...
            <div class="modal-content">
              ...
              <div class="form-group col-4">
                  ...
                  <select class="form-control form-control-sm" type="text" id="addType" name="addType">
                    <option value="cake" selected>蛋糕系列</option>
                    <option value="cashew">腰果醬</option>
                    <option value="pie">派系列</option>
                    <option value="cakeroll">歐蕾卷</option>
                    <option value="oat">燕麥蛋糕</option>
                    <option value="cookies">手工餅乾</option>
                    <option value="candy">牛軋糖</option>
                  </select>
                </div>
                <div class="form-group col-4">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a type="button" class="btn-readmore" href="orderDetail.php?orderId=<?=$order["id"]?>">查詢詳情</a>
              </td>
            </tr>
            <?php
            }
