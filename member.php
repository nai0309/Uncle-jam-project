  ...
  <section id="orderInfo" class="mb-5">
    <div class="container table-responsive">
      <table class="table table-striped">
        ...
        <tbody>
          <tr>
            <td scope="row">1111111</td>
            <td>方芳芳</td>
            <td>0987654321</td>
            <td>新北市大同區中正南路3段50號之七 六樓</td>
            <td>20200102</td>
            <td>待出貨</td>
            <td>＄999</td>
            <td>
              <a class="btn-readmore" data-toggle="modal" data-target=".orderDetail">查詢詳情</a>
            </td>
          </tr>
        </tbody>
      </table>
      <div class="modal fade orderDetail" tabindex="-1">
